 ...
 *
 */
export type SecurityPolicyModel =
  runtime.Types.Result.DefaultSelection<Prisma.$SecurityPolicyPayload>;
...
export type SecurityPolicyAggregateArgs<
...
> = {
   ...
   */
  orderBy?:
    | Prisma.SecurityPolicyOrderByWithRelationInput
    | Prisma.SecurityPolicyOrderByWithRelationInput[];
  /**
...
export type GetSecurityPolicyAggregateType<
  T extends SecurityPolicyAggregateArgs,
> = {
...
export type SecurityPolicyGroupByArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  where?: Prisma.SecurityPolicyWhereInput;
  orderBy?:
    | Prisma.SecurityPolicyOrderByWithAggregationInput
    | Prisma.SecurityPolicyOrderByWithAggregationInput[];
  by:
    | Prisma.SecurityPolicyScalarFieldEnum[]
    | Prisma.SecurityPolicyScalarFieldEnum;
...
type GetSecurityPolicyGroupByPayload<T extends SecurityPolicyGroupByArgs> =
  Prisma.PrismaPromise<
    Array<
      Prisma.PickEnumerable<SecurityPolicyGroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof SecurityPolicyGroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type SecurityPolicyWhereInput = {
  ...
  requireMfa?: Prisma.BoolFilter<'SecurityPolicy'> | boolean;
  maxConcurrentSessions?: Prisma.IntFilter<'SecurityPolicy'> | number;
...
export type SecurityPolicyScalarWhereWithAggregatesInput = {
  AND?:
    | Prisma.SecurityPolicyScalarWhereWithAggregatesInput
    | Prisma.SecurityPolicyScalarWhereWithAggregatesInput[];
  ...
  requireMfa?: Prisma.BoolWithAggregatesFilter<'SecurityPolicy'> | boolean;
  maxConcurrentSessions?:
    | Prisma.IntWithAggregatesFilter<'SecurityPolicy'>
    | number;
  ...
  updatedAt?:
    | Prisma.DateTimeWithAggregatesFilter<'SecurityPolicy'>
    | Date
    | string;
};
...
export type SecurityPolicySelect<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
...
export type SecurityPolicySelectCreateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type SecurityPolicySelectUpdateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type SecurityPolicyOmit<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
...
export type SecurityPolicyGetPayload<
  S extends boolean | null | undefined | SecurityPolicyDefaultArgs,
> = runtime.Types.Result.GetResult<Prisma.$SecurityPolicyPayload, S>;

export type SecurityPolicyCountArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = Omit<
  SecurityPolicyFindManyArgs,
  'select' | 'include' | 'distinct' | 'omit'
> & {
  select?: SecurityPolicyCountAggregateInputType | true;
};

export interface SecurityPolicyDelegate<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
  GlobalOmitOptions = {},
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>['model']['SecurityPolicy'];
    meta: { name: 'SecurityPolicy' };
  };
  /**
   ...
   * })
   */
  findUnique<T extends SecurityPolicyFindUniqueArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyFindUniqueArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
      'findUnique',
      GlobalOmitOptions
    > | null,
  ...
  findUniqueOrThrow<T extends SecurityPolicyFindUniqueOrThrowArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyFindUniqueOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirst<T extends SecurityPolicyFindFirstArgs>(
    args?: Prisma.SelectSubset<T, SecurityPolicyFindFirstArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirstOrThrow<T extends SecurityPolicyFindFirstOrThrowArgs>(
    args?: Prisma.SelectSubset<T, SecurityPolicyFindFirstOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   *
   */
  findMany<T extends SecurityPolicyFindManyArgs>(
    args?: Prisma.SelectSubset<T, SecurityPolicyFindManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   *
   */
  create<T extends SecurityPolicyCreateArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyCreateArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   *
   */
  createMany<T extends SecurityPolicyCreateManyArgs>(
    args?: Prisma.SelectSubset<T, SecurityPolicyCreateManyArgs<ExtArgs>>,
   ...
   *
   */
  createManyAndReturn<T extends SecurityPolicyCreateManyAndReturnArgs>(
    args?: Prisma.SelectSubset<
      T,
      SecurityPolicyCreateManyAndReturnArgs<ExtArgs>
    >,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
   ...
   *
   */
  delete<T extends SecurityPolicyDeleteArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyDeleteArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   *
   */
  update<T extends SecurityPolicyUpdateArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyUpdateArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
   ...
   *
   */
  deleteMany<T extends SecurityPolicyDeleteManyArgs>(
    args?: Prisma.SelectSubset<T, SecurityPolicyDeleteManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateMany<T extends SecurityPolicyUpdateManyArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyUpdateManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateManyAndReturn<T extends SecurityPolicyUpdateManyAndReturnArgs>(
    args: Prisma.SelectSubset<
      T,
      SecurityPolicyUpdateManyAndReturnArgs<ExtArgs>
    >,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
   ...
   * })
   */
  upsert<T extends SecurityPolicyUpsertArgs>(
    args: Prisma.SelectSubset<T, SecurityPolicyUpsertArgs<ExtArgs>>,
  ): Prisma.Prisma__SecurityPolicyClient<
    runtime.Types.Result.GetResult<
      Prisma.$SecurityPolicyPayload<ExtArgs>,
      T,
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ...
        : Prisma.GetScalarType<
            T['select'],
            SecurityPolicyCountAggregateOutputType
          >
      : number
  >;
   ...
   * })
   **/
  aggregate<T extends SecurityPolicyAggregateArgs>(
    args: Prisma.Subset<T, SecurityPolicyAggregateArgs>,
  ): Prisma.PrismaPromise<GetSecurityPolicyAggregateType<T>>;
  ...
  >(
    args: Prisma.SubsetIntersection<T, SecurityPolicyGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetSecurityPolicyGroupByPayload<T>
 ...
 */
export interface Prisma__SecurityPolicyClient<
  T,
  Null = never,
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
...
export interface SecurityPolicyFieldRefs {
  ...
  readonly requireMfa: Prisma.FieldRef<'SecurityPolicy', 'Boolean'>;
  readonly maxConcurrentSessions: Prisma.FieldRef<'SecurityPolicy', 'Int'>;
 ...
 */
export type SecurityPolicyFindUniqueArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyFindUniqueOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyFindFirstArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyFindFirstOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyFindManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyCreateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.SecurityPolicyCreateInput,
    Prisma.SecurityPolicyUncheckedCreateInput
  >;
};
 ...
 */
export type SecurityPolicyCreateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data:
    | Prisma.SecurityPolicyCreateManyInput
    | Prisma.SecurityPolicyCreateManyInput[];
 ...
 */
export type SecurityPolicyCreateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyUpdateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.SecurityPolicyUpdateInput,
    Prisma.SecurityPolicyUncheckedUpdateInput
  >;
  /**
 ...
 */
export type SecurityPolicyUpdateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.SecurityPolicyUpdateManyMutationInput,
    Prisma.SecurityPolicyUncheckedUpdateManyInput
  >;
  /**
 ...
 */
export type SecurityPolicyUpdateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyUpsertArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyDeleteArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyDeleteManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type SecurityPolicyDefaultArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
