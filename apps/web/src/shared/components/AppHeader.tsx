...
export function AppHeader({ onCreate, onAppsClick }: AppHeaderProps) {
  return (
    <header className="w-full flex h-[56px] items-center border-b border-border bg-background px-5">
