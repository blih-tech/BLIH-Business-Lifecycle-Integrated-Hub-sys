...
export function EmployeeDocumentClearanceSection({ items }: EmployeeDocumentClearanceSectionProps) {
  return (
    <section className="space-y-3">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-base font-medium tracking-[-0.176px] text-black">Employee Document Clearance</p>
