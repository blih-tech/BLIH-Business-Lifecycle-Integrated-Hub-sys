...
export function RecentlyClearedDocumentsSection({ items }: RecentlyClearedDocumentsSectionProps) {
  return (
    <Card className="gap-0 rounded-[12px] border-border py-0 shadow-none">
      <CardContent className="space-y-4 p-4">
        <p className="text-base font-medium tracking-[-0.176px] text-black">Recently Cleared Documents</p>
