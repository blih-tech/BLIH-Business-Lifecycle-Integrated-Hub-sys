...
export function RecentlyClearedDocumentCard({ item }: RecentlyClearedDocumentCardProps) {
  return (
    <div className="flex items-center justify-between rounded-[8px] bg-[#f3f3f3] p-[10px]">
      ...
      <Button variant="outline" className="h-16 w-[124px] flex-col gap-1 rounded-[6px] border-border bg-white text-[#666]">
