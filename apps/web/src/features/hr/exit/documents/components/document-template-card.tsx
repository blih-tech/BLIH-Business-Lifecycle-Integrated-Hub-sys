    ...
    <Card className="gap-0 rounded-[12px] border-border py-0 shadow-none">
      <CardContent className="space-y-4 p-4">
        ...
        <div className="flex gap-2">
          <Button size="sm" variant="outline" className="h-8 flex-1 rounded-[6px] border-border bg-white text-xs text-black">
            <Download className="h-3.5 w-3.5" />
          </Button>
          <Button size="sm" variant="outline" className="h-8 w-[38px] rounded-[6px] border-border bg-white text-black">
