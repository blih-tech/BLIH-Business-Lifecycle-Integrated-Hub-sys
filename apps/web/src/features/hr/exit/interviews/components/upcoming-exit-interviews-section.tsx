...
export function UpcomingExitInterviewsSection({ items }: UpcomingExitInterviewsSectionProps) {
  return (
    <section className="space-y-3">
      <p className="text-base font-medium tracking-[-0.176px] text-black">Upcoming Exit Interviews</p>
