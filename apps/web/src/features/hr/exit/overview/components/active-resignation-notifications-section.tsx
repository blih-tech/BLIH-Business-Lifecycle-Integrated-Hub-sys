...
export function ActiveResignationNotificationsSection({ items }: ActiveResignationNotificationsSectionProps) {
  return (
    <section className="space-y-3">
      <p className="text-base font-medium tracking-[-0.176px] text-black">Active Resignation Notifications</p>
