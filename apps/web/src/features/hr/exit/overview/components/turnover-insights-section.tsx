import type { ExitReasonItem, ResignationTrendPoint } from "@/features/hr/exit/overview/types";
...
export function TurnoverInsightsSection({ reasons, trendData }: TurnoverInsightsSectionProps) {
  return (
