...
export function ResignationNotificationCard({ item }: ResignationNotificationCardProps) {
  return (
      ...
      <CardContent className="space-y-0 px-[18px] pb-[18px] pt-[18px]">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm leading-5 tracking-[-0.1504px] text-[#666]">{item.summary}</p>
          </div>
        </div>
