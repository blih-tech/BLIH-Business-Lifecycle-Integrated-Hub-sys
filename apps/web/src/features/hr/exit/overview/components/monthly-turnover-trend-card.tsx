...
export function MonthlyTurnoverTrendCard({ data }: MonthlyTurnoverTrendCardProps) {
  return (
      ...
      <CardContent className="space-y-3 p-4">
        ...
        <ChartContainer config={chartConfig} className="h-[210px] w-full">
          <LineChart accessibilityLayer data={data} margin={{ left: 2, right: 10, top: 8, bottom: 0 }}>
            ...
            <Line type="monotone" dataKey="exits" stroke="var(--color-exits)" strokeWidth={2} dot={{ r: 3, fill: "#e7000b" }} />
            <Line type="monotone" dataKey="hires" stroke="var(--color-hires)" strokeWidth={2} dot={{ r: 3, fill: "var(--primary)" }} />
          </LineChart>
        </ChartContainer>
