import type { ExitResignRequestItem, ExitResignStatItem } from "@/features/hr/exit/resign/types";

export const exitResignStats: ExitResignStatItem[] = [
  { id: "total-received", label: "Total Received", value: "3", icon: "received" },
  { id: "pending-approval", label: "Pending Approval", value: "1", icon: "pending" },
...
export const exitResignRequests: ExitResignRequestItem[] = [
  {
    ...
    meta: [
      ...
      { id: "last-working-day", label: "Last Working Day", value: "2024-03-20" },
