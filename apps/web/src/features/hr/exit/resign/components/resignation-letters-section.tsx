...
export function ResignationLettersSection({ items }: ResignationLettersSectionProps) {
  return (
    <section className="space-y-3">
      <p className="text-base font-medium tracking-[-0.176px] text-black">Resignation Letters Received</p>
