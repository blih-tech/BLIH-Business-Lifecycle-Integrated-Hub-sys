  ...
  return (
    <main className="mx-auto w-full max-w-[960px] space-y-4 px-4 py-5 md:px-5 md:py-6">
      <section className="space-y-1">
        <h1 className="ui-section-title text-foreground">Interviews and Schedules</h1>
        <p className="ui-body text-muted-foreground">Track candidates through the hiring pipeline.</p>
      </section>
