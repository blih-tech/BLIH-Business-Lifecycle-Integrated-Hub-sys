  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[1.3fr_0.75fr_1fr]">
      <article className="min-w-0 overflow-hidden rounded-[12px] border border-border p-4">
        <p className="text-sm tracking-[-0.2px] text-black">Salary Expectations</p>
      ...
      <article className="min-w-0 overflow-hidden rounded-[12px] border border-border p-4">
        <p className="text-sm tracking-[-0.2px] text-black">Gender Distribution</p>
        <ChartContainer config={genderConfig} className="mt-4 h-[150px] w-full min-w-0">
          <PieChart>
            <Pie data={genderDistribution} dataKey="value" nameKey="name" innerRadius={0} outerRadius={56} paddingAngle={0}>
      ...
      <article className="min-w-0 overflow-hidden rounded-[12px] border border-border p-4">
        <p className="text-sm tracking-[-0.2px] text-black">Experience Distribution</p>
