...
export const recruitmentStats: RecruitmentStatItem[] = [
  { id: "pending-requests", label: "Pending Requests", value: "45", icon: "clock-3" },
  { id: "active-recruitments", label: "Active Recruitments", value: "28", icon: "circle-check-big" },
  { id: "total-employees", label: "Total Employees", value: "12", icon: "user-round-plus" },
];
