...
export const budgetStats: BudgetStat[] = [
  { id: "allocated", label: "Total Allocated", value: "$1.79M", icon: "allocated" },
  { id: "spent", label: "Total Spent", value: "$1.25M", icon: "spent" },
  { id: "remaining", label: "Remaining", value: "$0.55M", icon: "remaining" },
  { id: "utilization", label: "Utilization", value: "69.6%", icon: "utilization" },
];
...
export const budgetAllocations: BudgetAllocationItem[] = [
  {
    ...
    period: "Q1 2024",
    description: "Development of new product features and infrastructure upgrades",
...
export const annualBudgets: AnnualBudgetItem[] = [
  {
    ...
    totalSpent: "$6.98M",
    breakdown: [
      { id: "ab-1-eng", department: "Engineering", allocated: "$2100k", spent: "$2050k" },
      { id: "ab-1-mkt", department: "Marketing", allocated: "$950k", spent: "$920k" },
      { id: "ab-1-sales", department: "Sales", allocated: "$1300k", spent: "$1280k" },
    ],
  },
  {
    id: "ab-2",
    ...
    totalSpent: "$6.98M",
    breakdown: [
      { id: "ab-2-eng", department: "Engineering", allocated: "$2100k", spent: "$2050k" },
      { id: "ab-2-mkt", department: "Marketing", allocated: "$950k", spent: "$920k" },
      { id: "ab-2-sales", department: "Sales", allocated: "$1300k", spent: "$1280k" },
    ],
  },
];
