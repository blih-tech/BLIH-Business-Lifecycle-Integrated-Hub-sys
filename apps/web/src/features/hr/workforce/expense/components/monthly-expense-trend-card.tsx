...
export function MonthlyExpenseTrendCard({ data }: MonthlyExpenseTrendCardProps) {
  return (
    <Card className="gap-0 rounded-[12px] border-border py-0 shadow-none">
      <CardContent className="space-y-3 p-4">
        <p className="text-sm font-medium tracking-[-0.176px] text-black">Monthly Expense Trend</p>
