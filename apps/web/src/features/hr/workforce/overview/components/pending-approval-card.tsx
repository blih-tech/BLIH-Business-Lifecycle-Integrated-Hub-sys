    ...
    <Card className="gap-0 rounded-[10px] border-border py-0 shadow-none">
      <CardContent className="space-y-4 p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              <p className="text-base font-semibold leading-6 tracking-[-0.3125px] text-black">{item.title}</p>
          ...
          <div className="text-right">
            <p className="text-[24px] font-semibold leading-7 tracking-[-0.4395px] text-primary">{item.amount}</p>
            <p className="text-[11px] text-[#666]">Requested: {item.requestedDate}</p>
          </div>
        </div>
        <div className="flex justify-end gap-2">
          ...
          <Button size="sm" className="h-8 min-w-[88px] rounded-[6px] px-4 text-sm">
            Approve
          </Button>
        </div>
      </CardContent>
