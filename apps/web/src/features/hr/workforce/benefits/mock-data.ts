...
export const benefitsStats: BenefitsStat[] = [
  { id: "total", label: "Total Benefits Value", value: "$2.85M", trend: "+12%", icon: "total" },
  { id: "average", label: "Avg per Employee", value: "$18,269", trend: "+8%", icon: "average" },
  { id: "enrollments", label: "Active Enrollments", value: "156", trend: "100%", icon: "enrollments" },
];
...
export const profitSharingTiers: ProfitSharingTier[] = [
  { id: "exec", label: "Executive", employees: "8 employees", amount: "$100,000", average: "$12,500 avg", utilization: 70 },
  { id: "senior", label: "Senior", employees: "28 employees", amount: "$140,000", average: "$5,000 avg", utilization: 62 },
  { id: "mid", label: "Mid-level", employees: "56 employees", amount: "$140,000", average: "$2,500 avg", utilization: 78 },
  { id: "junior", label: "Junior", employees: "50 employees", amount: "$70,000", average: "$1,400 avg", utilization: 66 },
];
...
export const benefitsPrograms: BenefitsProgram[] = [
  { id: "bp-1", title: "Gym Membership", budget: "$42,000", participants: "95" },
  { id: "bp-2", title: "Childcare Assistance", budget: "$85,000", participants: "38" },
  { id: "bp-3", title: "Tuition Reimbursement", budget: "$120,000", participants: "24" },
  { id: "bp-4", title: "Employee Assistance Program", budget: "$35,000", participants: "156" },
];
...
export const additionalBenefits: AdditionalBenefitItem[] = [
  { id: "ab-1", title: "Professional Development", budget: "$150,000", participants: "89" },
  { id: "ab-2", title: "Wellness Programs", budget: "$75,000", participants: "120" },
  { id: "ab-3", title: "Gym Membership", budget: "$42,000", participants: "95" },
  { id: "ab-4", title: "Childcare Assistance", budget: "$85,000", participants: "38" },
  { id: "ab-5", title: "Tuition Reimbursement", budget: "$120,000", participants: "24" },
  { id: "ab-6", title: "Employee Assistance Program", budget: "$35,000", participants: "156" },
];
...
export const departmentBenefitSummaries: DepartmentBenefitSummary[] = [
  { id: "db-1", department: "Engineering", employees: "45 employees", average: "$19.9k avg" },
  { id: "db-2", department: "Marketing", employees: "28 employees", average: "$18.6k avg" },
  { id: "db-3", department: "Sales", employees: "32 employees", average: "$19.2k avg" },
  { id: "db-4", department: "Design", employees: "18 employees", average: "$19.2k avg" },
  { id: "db-5", department: "Analytics", employees: "15 employees", average: "$19.0k avg" },
  { id: "db-6", department: "HR", employees: "12 employees", average: "$15.8k avg" },
];
