...
export function AdditionalBenefitsSection({ items }: AdditionalBenefitsSectionProps) {
  return (
    <Card className="gap-0 rounded-[12px] border-border py-0 shadow-none">
      <CardContent className="space-y-4 p-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-base tracking-[-0.3125px] text-black">Additional Benefits &amp; Perks</p>
        </div>
