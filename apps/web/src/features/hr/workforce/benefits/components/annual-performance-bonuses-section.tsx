...
export function AnnualPerformanceBonusesSection({
  summaries,
  recipients,
}: AnnualPerformanceBonusesSectionProps) {
  return (
      ...
      <CardContent className="space-y-4 p-4">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {summaries.map((summary) => (
            <div
              key={summary.id}
              className="rounded-[12px] border border-[#e5e5e5] bg-white px-3 py-2 text-center"
            >
