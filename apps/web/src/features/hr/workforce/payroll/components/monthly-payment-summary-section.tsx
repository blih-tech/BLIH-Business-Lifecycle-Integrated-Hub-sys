...
export function MonthlyPaymentSummarySection({ items }: MonthlyPaymentSummarySectionProps) {
  return (
    <Card className="gap-0 rounded-[12px] border-border py-0 shadow-none">
      <CardContent className="space-y-3 p-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <p className="text-sm font-medium tracking-[-0.176px] text-black">Monthly Payment Summary</p>
