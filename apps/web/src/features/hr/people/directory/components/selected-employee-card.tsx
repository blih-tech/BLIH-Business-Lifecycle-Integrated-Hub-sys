  ...
  return (
    <aside className="flex h-[800px] flex-col justify-between rounded-[12px] border border-border bg-card p-[25px]">
      ...
      <div className="grid grid-cols-2 gap-x-2 gap-y-4 rounded-[8px] bg-muted p-4">
        ...
        <div>
          <p className="text-[11px] text-muted-foreground">Salary & Payroll</p>
          <p className="text-sm font-semibold text-foreground">
            {employee.salary}
          </p>
        </div>
      ...
      <div className="rounded-[8px] border border-primary bg-primary/10 p-2">
        ...
        <ChartContainer config={chartConfig} className="h-[125px] w-full !aspect-auto">
          <LineChart
            accessibilityLayer
          ...
          >
            ...
            <Line
              ...
              strokeWidth={2.5}
              dot={{ r: 2.2, fill: 'var(--color-performance)', strokeWidth: 0 }}
              activeDot={{ r: 3 }}
            />
          </LineChart>
        </ChartContainer>
