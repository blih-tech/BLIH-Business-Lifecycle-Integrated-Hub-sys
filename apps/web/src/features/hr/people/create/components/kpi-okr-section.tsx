    ...
    <div className="grid gap-4 md:grid-cols-2 md:gap-8">
      <FormSectionCard title="KPI Targets">
        <div className="space-y-4">
          <TargetSelectField name="kpiTarget1" label="Key Performance Indicator 1" />
          <TargetSelectField name="kpiTarget2" label="Key Performance Indicator 2" />
          <TargetSelectField name="kpiTarget3" label="Key Performance Indicator 3" />
      ...
      <FormSectionCard title="OKR Targets">
        <div className="space-y-4">
          <TargetSelectField name="okrTarget1" label="Objective & Key Result 1" />
          <TargetSelectField name="okrTarget2" label="Objective & Key Result 2" />
          <Button type="button" variant="outline" className="h-8 rounded-[6px] border-[#e5e5e5] text-[#666]">
            <Plus className="h-4 w-4" />
            Add OKR
          </Button>
