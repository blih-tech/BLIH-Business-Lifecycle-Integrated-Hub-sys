    ...
    <FormSectionCard title="Documents">
      <div className="grid gap-6 md:grid-cols-2 md:gap-8">
        <div className="space-y-4">
          ...
          <UploadField name="educationalDocument" label="Educational Document" required />
        </div>
        <div className="space-y-4">
          <UploadField name="experienceCertificate" label="Experience Certificate" />
          <UploadField name="recommendationLetters" label="Recommendation Letters" />
        </div>
      </div>
