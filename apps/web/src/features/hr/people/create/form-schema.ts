...
export const employeeProfileFormSchema = z.object({
  ...
  offerLetterSource: z.string().min(1, "Select offer letter source."),
  department: z.string().min(1, "Please select a department."),
  reportingTo: z.string().min(2, "Reporting manager is required."),
  rolePosition: z.string().min(2, "Role/position is required."),
  ...
  compensationNotes: z.string().max(400, "Notes must be 400 characters or less.").optional(),
  awashBankAccountName: z.string().min(2, "Awash bank account name is required."),
  awashBankAccountNumber: z.string().min(6, "Awash account number is required."),
  ...
  emergencyFirstName: z.string().min(2, "Emergency contact first name is required."),
  emergencyLastName: z.string().min(2, "Emergency contact last name is required."),
  emergencyPhoneNumber: z.string().min(10, "Emergency phone number is required."),
  emergencyEmail: z.string().email("Please enter a valid emergency email."),
