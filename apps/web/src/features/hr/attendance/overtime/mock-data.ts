...
export const attendanceOvertimeStats: AttendanceOvertimeStat[] = [
  { id: "wfh-month", label: "Total WFH Requests This Month", value: "12", icon: "clock-3" },
  { id: "pending-approval", label: "Pending Approval", value: "28", icon: "clock-3" },
  { id: "wfh-total", label: "Total Work-From-Home Requests", value: "45", icon: "circle-check-big" },
];
...
export const previousOvertimeRows: PreviousOvertimeRow[] = Array.from({ length: 10 }, (_, idx) => ({
  id: `po-${idx + 1}`,
  name: "Jessica Parker",
  initials: "JP",
  role: "Full Stack Developer",
