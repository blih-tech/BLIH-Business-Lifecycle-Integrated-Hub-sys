...
const employees: EmployeeSeed[] = [
  { id: "emp-1", name: "Jessica Parker", initials: "JP", department: "Marketing" },
  { id: "emp-2", name: "James Price", initials: "JP", department: "Finance" },
  { id: "emp-3", name: "Joan Peters", initials: "JP", department: "Technology" },
  { id: "emp-4", name: "Jaden Porter", initials: "JP", department: "Marketing" },
  { id: "emp-5", name: "Julia Pratt", initials: "JP", department: "Marketing" },
  { id: "emp-6", name: "Jeremy Pike", initials: "JP", department: "Technology" },
  { id: "emp-7", name: "Jasmine Prince", initials: "JP", department: "Finance" },
...
function buildRows(seed: string) {
  ...
  return employees.map((employee, index) => {
    ...
    const stamps = status === "completed" ? completedStamps : status === "in-progress" ? inProgressStamps : missedStamps;
...
export const attendanceCheckinStats: AttendanceCheckinStatItem[] = [
  ...
  { id: "total-checkins", label: "Total Check-ins", value: "28", icon: "circle-check-big" },
  { id: "completed", label: "Completed", value: "45", icon: "circle-check-big" },
];
...
export const checkinDepartments = ["all", "Marketing", "Finance", "Technology"] as const;

export const checkinStatusOptions = ["all", "completed", "in-progress", "missed"] as const;
