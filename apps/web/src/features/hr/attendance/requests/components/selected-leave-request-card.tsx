...
export function SelectedLeaveRequestCard({ request }: SelectedLeaveRequestCardProps) {
  return (
    <aside className="rounded-[12px] border border-border bg-card p-4">
      <div className="space-y-4">
        ...
        <div className="rounded-[8px] bg-[#f5f5f5] p-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            {request.documents.map((doc) => (
              <div key={doc} className="flex h-8 items-center gap-2 rounded-[4px] border border-border bg-white px-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button className="h-8 rounded-[4px] text-[11px]">View Profile</Button>
          <Button variant="outline" className="h-8 rounded-[4px] border-border bg-[#f3f3f3] text-[11px] text-black">
            Download Files
          </Button>
        </div>
      </div>
