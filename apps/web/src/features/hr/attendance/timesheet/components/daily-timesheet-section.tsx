...
export function DailyTimesheetSection() {
  ...
  return (
    <section className="space-y-8">
      <div>
        <p className="text-[22px] font-semibold tracking-[-0.3125px] text-black">Employee Timesheet</p>
      ...
      <div>
        ...
        />
        <TimesheetPagination currentPage={safePage} totalPages={totalPages} onPageChange={setPage} />
      </div>
    </section>
  );
}
