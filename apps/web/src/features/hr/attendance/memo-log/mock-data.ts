import type { AttendanceMemoStat, MemoCardItem, PreviousMemoRow } from "@/features/hr/attendance/memo-log/types";

export const attendanceMemoStats: AttendanceMemoStat[] = [
  { id: "week-logs", label: "Memo Logs This Week", value: "12", icon: "clock-3" },
  { id: "pending-approval", label: "Pending Approval", value: "28", icon: "clock-3" },
  { id: "total-memos", label: "Total Memo Logs", value: "45", icon: "circle-check-big" },
];
...
export const previousMemoRows: PreviousMemoRow[] = Array.from({ length: 10 }, (_, index) => ({
  id: `pm-${index + 1}`,
  name: "Jessica Parker",
  initials: "JP",
  role: "Full Stack Developer",
