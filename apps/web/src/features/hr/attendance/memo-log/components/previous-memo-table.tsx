...
type PreviousMemoTableProps = {
  rows: PreviousMemoRow[];
  totalRows: number;
  currentPage: number;
  totalPages: number;
...
export function PreviousMemoTable({
  rows,
  totalRows,
  currentPage,
  totalPages,
    ...
    <section className="rounded-[12px] bg-card p-0">
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select defaultValue="Overtime Type">
            <SelectTrigger
              size="sm"
            ...
            <SelectContent>
              <SelectItem value="Overtime Type">Overtime Type</SelectItem>
