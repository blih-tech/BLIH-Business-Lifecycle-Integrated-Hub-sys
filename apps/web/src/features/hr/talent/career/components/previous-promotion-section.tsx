...
export function PreviousPromotionSection({
  items,
}: PreviousPromotionSectionProps) {
  return (
    <section className="space-y-3">
      ...
      <div className="flex justify-end">
        <Button
          variant="ghost"
          size="sm"
          className="h-auto cursor-pointer gap-1 p-0 text-xs font-normal text-[#666] hover:bg-transparent hover:text-[#666]"
        >
          See More
