        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              <Badge variant="outline" className="h-5 rounded-[4px] px-1.5 text-[9px] font-medium text-black">
                {item.department}
              </Badge>
            </div>
            <p className="mt-1 text-[10px] font-semibold uppercase tracking-[0.2px] text-primary">{item.requestType}</p>
