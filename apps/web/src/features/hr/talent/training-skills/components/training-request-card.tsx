      ...
      <CardContent className="space-y-3 p-4">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0">
              <div className="mb-1 flex items-center gap-1.5">
                <p className="text-sm font-semibold tracking-[-0.3125px] text-black">
                  {item.name}
                </p>
              ...
              <p className="text-base font-medium leading-6 tracking-[-0.3125px] text-primary">
                {item.title}
              </p>
        ...
        <div className="grid gap-2 xl:grid-cols-[1fr_367px] xl:gap-5">
          <div className="rounded-[4px] border border-[#e3e3e3] bg-[#dbe6fb] px-[11px] py-[11px] text-sm text-[rgba(0,0,0,0.7)]">
            <span className="font-medium text-black">Justification:</span>{' '}
            {item.justification}
          </div>
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button
              size="sm"
              variant="outline"
              className="h-10 rounded-[6px] border-border bg-white text-sm text-black"
            >
...
function Metric({
  ...
  return (
    <div className="px-2 py-2">
      ...
      <p
        className={`text-base font-semibold leading-6 tracking-[-0.3125px] ${isPrimary ? 'text-primary' : 'text-black'}`}
      >
        {value}
      </p>
    </div>
