...
export function SkillGapAssessmentsSection({ items }: SkillGapAssessmentsSectionProps) {
  return (
    <section className="space-y-3">
      <p className="text-base font-medium tracking-[-0.176px] text-black">Skill Gap Assessments</p>
