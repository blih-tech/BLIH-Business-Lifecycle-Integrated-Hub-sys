...
export function ActiveInitiativesHeader({ totalPrograms }: ActiveInitiativesHeaderProps) {
  return (
    <Card className="gap-0 rounded-[10px] border-border py-0 shadow-none">
      <CardContent className="flex items-center justify-between p-3">
        <p className="text-base font-medium tracking-[-0.176px] text-black">Active Culture Initiatives</p>
