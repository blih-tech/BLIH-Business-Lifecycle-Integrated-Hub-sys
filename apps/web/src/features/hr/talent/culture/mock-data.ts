...
export const culturePolicies: CulturePolicy[] = [
  {
    ...
    description: "Our core values guide everything we do, from hiring to daily operations.",
  ...
  },
  {
    ...
    description: "Professional standards and behavioral expectations for all employees.",
  ...
  },
  {
    ...
    description: "Our commitment to creating an inclusive workplace for everyone.",
  ...
  },
  {
    ...
    description: "Policies supporting employee wellbeing and flexible work arrangements.",
