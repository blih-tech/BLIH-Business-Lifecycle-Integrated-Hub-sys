import type { ChecklistSummaryStat, ChecklistTemplate } from "@/features/hr/onboarding/checklists/types";

export const checklistSummaryStats: ChecklistSummaryStat[] = [
  { id: "total-checklists", label: "Total Checklists", value: "3", icon: "check-square" },
  { id: "total-items", label: "Total Items", value: "37", icon: "check-square" },
