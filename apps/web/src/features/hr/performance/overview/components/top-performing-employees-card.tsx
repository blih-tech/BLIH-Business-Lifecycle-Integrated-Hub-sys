...
export function TopPerformingEmployeesCard({
  items,
}: TopPerformingEmployeesCardProps) {
  return (
      ...
      <CardContent className="p-3 md:p-4">
        ...
        <div className="space-y-2">
          {items.map((employee) => (
            <div
              key={employee.id}
              className="flex items-center justify-between rounded-[8px] border border-border bg-card p-2.5"
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="rounded-[3px] bg-[#f3f3f3] px-1.5 py-0.5 text-[9px] text-black">
                  OKR: {employee.okr}%
                </span>
                <span className="rounded-[3px] bg-[#f3f3f3] px-1.5 py-0.5 text-[9px] text-black">
                  KPI: {employee.kpi}%
