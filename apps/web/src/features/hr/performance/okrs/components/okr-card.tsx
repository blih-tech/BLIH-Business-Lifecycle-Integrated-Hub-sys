      ...
      <CardContent className="p-0">
        <div className="flex items-start justify-between px-4 py-3">
          ...
          <div className="text-right">
            ...
            <p className="mt-1 text-[32px] font-bold leading-8 text-primary">
              {item.overallScore}%
            </p>
              ...
              <div>
                ...
                <div className="mt-4">
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <p className="text-[30px] font-bold leading-7 text-primary">
                      {item.overallScore}%
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {item.keyImpacts.map((impact) => (
                    <div
                      key={impact}
                      className="rounded-[6px] bg-[#f3f3f3] px-2.5 py-2 text-xs text-black"
                    >
                      {impact}
                    </div>
                  ))}
