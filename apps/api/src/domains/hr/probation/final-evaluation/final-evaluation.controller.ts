...
export class FinalEvaluationController {
  constructor(
    ...
    private readonly _getById: GetFinalEvaluationByIdUseCase,
    private readonly _getByProbation: GetFinalEvaluationByProbationUseCase,
  ...
  getByProbation(@Param('probationId') probationId: string) {
    return this._getByProbation.execute(probationId);
  }
