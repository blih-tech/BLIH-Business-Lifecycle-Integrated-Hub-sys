...
- **Fan-Out:** If a node outputs 10 items, the *next* node runs 10 times (or once with 10 items, depending on node type).
  - *HTTP Request Node:* Runs 10 times (1 request per item).
  - *Code Node:* Runs 1 time (receives all 10 items).
